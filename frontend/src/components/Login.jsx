...
import { Mail, Lock, LogIn, Flame, Sparkles, Shield } from "lucide-react";
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="hidden md:flex w-2/5 bg-neutral p-10 flex-col justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-black tracking-tighter text-neutral-content">DEVTINDER</span>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-neutral-content uppercase tracking-widest">Secure Access</h4>
                  <p className="text-[11px] text-neutral-content/60 leading-relaxed mt-1">End-to-end encrypted authentication for developers.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 p-8 md:p-12">
            <div className="mb-10">
              <h2 className="text-2xl font-bold tracking-tight text-base-content uppercase">Sign In</h2>
            ...
            <div className="space-y-5">
              ...
              <div className="form-control">
                <label className="label py-1">
                  <span className="text-[10px] font-bold uppercase opacity-50 tracking-widest">Email</span>
                </label>
              ...
              <div className="form-control">
                <label className="label py-1">
                  <span className="text-[10px] font-bold uppercase opacity-50 tracking-widest">Password</span>
                </label>
                <div className="relative">
              ...
              <button
                ...
                onClick={SubmitForm}
              >
                <LogIn size={16} /> Authorize Session
              </button>
