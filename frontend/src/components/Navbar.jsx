  ...
  return (
    <div className="navbar bg-base-100 shadow-lg sticky top-0 z-50 px-4">
      ...
      <div className="navbar-start">
        <Link to="/" className="btn btn-ghost text-2xl font-bold text-primary hover:scale-105 transition-transform">
          🔥 DevTinder
        </Link>
      </div>
      ...
      <div className="navbar-end gap-2">
        ...
        <div className="dropdown dropdown-end">
          ...
          <div
            tabIndex={0}
            className="card compact dropdown-content bg-base-100 rounded-box z-[1] w-80 shadow-lg mt-3 border border-base-300"
          >
            <div className="card-body">
              <h3 className="font-bold text-lg mb-2">Notifications</h3>
              <div className="space-y-2">
                <div className="alert alert-info py-2">
                  <span className="text-sm">John liked your profile</span>
                </div>
                <div className="alert alert-success py-2">
                  <span className="text-sm">New match with Sarah!</span>
                </div>
                <div className="alert py-2">
                  <span className="text-sm">Mike viewed your profile</span>
                </div>
              </div>
            </div>
          </div>
